...
import { Calendar as CalendarIcon, Plus, Edit, Trash2, ChevronLeft, ChevronRight, Eye, MoreVertical } from "lucide-react"
...
export default function Calendar() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'in-progress': return 'bg-warning text-warning-foreground border-warning'
      case 'todo': return 'bg-transparent border-muted'
      default: return 'bg-transparent border-muted'
    }
  }
                  ...
                  {calendarDays.map(date => {
                    ...
                    return (
                      <div
                        ...
                        className={`p-2 h-24 border border-border rounded-lg cursor-pointer hover:bg-accent/50 transition-colors ${
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 mb-1 flex-wrap">
                                <h4 className="font-medium">
                                  {isMobile ? truncateText(task.title, 18) : task.title}
                                </h4>
